                                    ...
                                    @foreach($toppings as $topping)
                                        <div class="relative flex items-start py-4">
                                            ...
                                            <div class="ml-3 flex items-center h-5">
                                                <input id="topping-{{$topping->id}}" @if($item->toppings->contains($topping->id)) checked @endif name="toppings[{{$topping->id}}]" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
