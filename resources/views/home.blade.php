...
<div class="container">
    <div class="row mb-2">
        <div class="col-md-4 offset-1">
            <a href="{{route('order.create')}}"><button type="button" class="btn-sm btn-success">Nieuwe bestelling</button></a>
        </div>
    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($unfinishedOrders as $unfinishedOrder)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('order.edit', ['id' => $unfinishedOrder->id])}}">
                        ...
                        <table class="table">
                            ...
                            @foreach($finishedOrders as $finishedOrder)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('order.show', ['id' => $finishedOrder->id])}}">
                                            <button type="button" class="btn-sm btn-info text-white">Bekijk</button>
                                            @if($finishedOrder->admin_note)
                                                <button type="button" class="btn-sm btn-warning ml-2" data-toggle="tooltip" data-placement="top" title="Er is een notitie">Attentie, bekijk bestelling!</button>
                                            @endif
                                        </a>
                                    </td>
